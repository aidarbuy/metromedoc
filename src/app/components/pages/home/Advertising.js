  ...
  <div id="slider-wrapper" style={styles.wrapper}>
    <div id="layerslider" style={styles.slider}>
      ...
      <div className="ls-slide" data-ls="slidedelay:10500; transition2d: 15-18, 59-61, 90, 91, 30-32, 69-72, 40-43, 92, 96, 97, 75-79, 81, 82, 86, 87-89, 93-95, 111, 103-105, 109, 112">
        ...
        <h4 className="ls-l" data-ls="offsetxin: 0; offsetyin: top; durationin: 3000; delayin: 100; easingin: easeOutElastic; fadein: false; offsetxout: left; durationout: 1500; showuntil: 5250; easingout: easeInBack; fadeout: false;" style={{top: 290, left: 390, whiteSpace: 'nowrap', fontSize: 70, fontWeight: 'normal', color: '#F50057'}}>Care</h4>
        <h5 className="ls-l" data-ls="offsetxin: -100; offsetxout: 0; offsetyin: 0; offsetyout: bottom; durationin: 2500; delayin: 2000; skewxin: 60;" style={{top: 450, left: 125, fontSize: 30, color: '#FF3D00'}}>When medical treatment is fun :)</h5>
        {/* 75-79, 81, 82, 86, 87-89, 93-95, 111, 103-105, 109, 112 3d: 19, 20, 22, 23, 26, 62 63, 68, 69, 76 */}
      </div>
    </div>
  </div>
);