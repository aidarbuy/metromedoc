...
const hours = [
	["Monday &ndash; Friday", "9 am - 7 pm"],
	["Saturday", "closed"],
  ["Sunday", "closed"],
];

const getLinkStyles = (linkColor) => {return {color:linkColor}};
const colClassName = "col-xs-12 col-md-12 col-sm-6 col-lg-3 text-center";
const zDepth = 2;
...
export default ({bgColor, textColor}) => (
	<div className="container-fluid">
      ...
      <Paper className={colClassName} style={getPaperStyles()} zDepth={zDepth}>
        <div style={getCellStyles(textColor, bgColor)} className="cell">
          <h5>Clinic News</h5>
          <p>New Hours of Operation starting October 1&nbsp;st 2016. Monday through Friday 9 am to 7&nbsp;pm. Closed Saturdays and Sundays</p>
        </div>
      </Paper>
      ...
      <Paper className={colClassName} style={getPaperStyles()} zDepth={zDepth}>
        <div style={getCellStyles(textColor, bgColor)} className="cell">
          ...
          <p><Link to="/location" style={getLinkStyles(textColor)}>952 Edwards Ferry Rd NE</Link><br/><Link to="/locati<L" style={getLinkStyles(textColor)}>Leesburg, VA 20176</Link></p>
